...
void insert_INDX(Link_List* list, int indx, void* data);
...
void change_INDX(const Link_List* list, int indx, void* data);
int size_LIST(const Link_List* list);
bool is_EMPT(const Link_List* list);

void clean_LIST(Link_List* list);
void print_LIST(Link_List* list, void (*print_func)(const void*));
